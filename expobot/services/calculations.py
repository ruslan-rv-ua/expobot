...
def level_to_price(level: int, level_height:float,level_0_price:float) -> float:
    """
    ...
    """
    return level_0_price * level_height ** level

def price_to_level(price: float, level_height:float,level_0_price:float) -> int:
    """
